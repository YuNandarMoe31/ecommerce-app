                ...
                <div class="col-12">
                    <div class="new_arrivals_slides owl-carousel">
                        ...
                        <div class="single-product-area">
                            <div class="product_image">
                                <!-- Product Image -->
                                <img class="normal_img" src="{{ asset('frontend/img/product-img/new-6.png') }}"
                                    alt="">
                        ...
                        <div class="single-product-area">
                            <div class="product_image">
                                <!-- Product Image -->
                                <img class="normal_img" src="{{ asset('frontend/img/product-img/new-2.png') }}"
                                    alt="">
                        ...
                        <div class="single-product-area">
                            <div class="product_image">
                                <!-- Product Image -->
                                <img class="normal_img" src="{{ asset('frontend/img/product-img/new-4.png') }}"
                                    alt="">
                        ...
                        <div class="single-product-area">
                            <div class="product_image">
                                <!-- Product Image -->
                                <img class="normal_img" src="{{ asset('frontend/img/product-img/new-5.png') }}"
                                    alt="">
                ...
                <div class="col-12 col-lg-6">
                    ...
                    <div class="featured_product_slides owl-carousel">
                        ...
                        <div class="single-product-area">
                            <div class="product_image">
                                <!-- Product Image -->
                                <img class="normal_img" src="{{ asset('frontend/img/product-img/new-7.png') }}"
                                    alt="">

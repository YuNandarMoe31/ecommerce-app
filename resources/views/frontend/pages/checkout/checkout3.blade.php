                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12 col-md-6 mb-3">
                                                                ...
                                                                <small id="card_info_store" class="form-text text-muted"><i
                                                                    ...
                                                                    payment
                                                                    info is stored securely. <a href="#">Learn
                                                                        More</a></small>
                                                            </div>
                                        ...
                                        <div class="panel-heading" role="tab" id="two">
                                            <h6 class="panel-title">
                                                <a class="collapsed" role="button" data-toggle="collapse"
                                                    ...
                                                    aria-controls="collapse_two"><i class="icofont-paypal-alt"></i> Pay
                                                    with
                                                    PayPal</a>
                                            </h6>
                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12 col-md-6 mb-3">
                                                                ...
                                                                <small id="paypal_info" class="form-text text-muted"><i
                                                                    ...
                                                                    online payments at the speed of want. <a
                                                            ...
                                                            <div class="col-12 col-md-6 mb-3">
                                                                ...
                                                                <small id="paypal_password"
                                                                    class="form-text text-muted"><a href="#">Forget
                                                                        Password?</a></small>
                                                            </div>
                                                            <div class="col-12">
                                                                <button type="submit"
                                            ...
                                            <h6 class="panel-title">
                                                <a class="collapsed" role="button" data-toggle="collapse"
                                                    ...
                                                    aria-controls="collapse_three"><i
                                                        class="icofont-bank-transfer-alt"></i>
